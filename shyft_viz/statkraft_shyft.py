...
class Region(object):
    ...
    def view(self, t=None, plots={}):
        ...
        rm_dct = {'arome00-ec00': [rm_update, sim.region_model_arome00, sim.region_model_arome00_ec00],
                  'arome06-ec00': [rm_update, sim.region_model_arome06, sim.region_model_arome06_ec00],
                  'arome12-ec00': [rm_update, sim.region_model_arome12, sim.region_model_arome12_ec00],
                  'arome18-ec00': [rm_update, sim.region_model_arome18, sim.region_model_arome18_ec00],
                  'arome00-ec12': [rm_update, sim.region_model_arome00, sim.region_model_arome00_ec12],
                  'arome06-ec12': [rm_update, sim.region_model_arome06, sim.region_model_arome06_ec12],
